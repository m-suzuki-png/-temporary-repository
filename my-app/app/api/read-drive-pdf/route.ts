          ...
          content: [
            ...
            },
            {
              ...
              text: `
                  ...
                  5. 図・カラー・見出しを使い、ITに詳しくない人にも分かるようにしてください。図は、パワーポイントなどで使えそうなもので棒グラフや折れ線グラフなど視覚的にわかりやすく
                  6.もしこれらの脅威が発生した場合どのようなリスクが起きるかの説明と、checkpointがあることによってどれだけ助かったかを説明する

                  これはそのままお客さんに提出するので、私ではなくてお客様に向かっての言葉にしてください
` 
              },
          ],
        },
